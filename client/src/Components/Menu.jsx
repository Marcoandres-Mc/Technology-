...
export function Menu({isDrawerOpen}) {
  ...
  return (
    <div className="h-0 sm:h-[100%] bg-blue-gray-400" >
        <Drawer className=" mt-[75px] md:m-0 sm:p-0 h-full bg-blue-gray-400" open={isDrawerOpen} onClose={() => {}} overlay={false} >
            <Card className="w[250px] shadow-xl shadow-blue-gray-900/5">
            <div className="mb-2 flex items-center gap-4 p-6" style={{ backgroundColor: '#5edee7' }}>
